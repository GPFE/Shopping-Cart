import { Card, CardFooter, Box, Accordion, AccordionButton, AccordionPanel, AccordionIcon, AccordionItem, Container, Grid, Image, Stack, HStack, CardBody, Heading, Text, Button } from "@chakra-ui/react"
        ...
        <Container pt={"2rem"} maxWidth={"1000px"}>
                ...
                <Grid gridTemplateColumns={"1fr 1fr 1fr"} gap={"1rem"}>
                    <Card>
                        ...
                        <CardBody>
                            ...
                            <Text p={".5rem"} opacity={.8}>
                                Browsing products is a breeze. Love how fast it loads on my phone too.
                            </Text>
                        </CardBody>
                    </Card>
                    <Card>
                        ...
                        <CardBody>
                            ...
                            <Text p={".5rem"} opacity={.8}>
                                The design is so clean it feels like a legit ecommerce site. Smooth transitions, too.
                            </Text>
                        </CardBody>
                    </Card>
                    <Card>
                        ...
                        <CardBody>
                            ...
                            <Text p={".5rem"} opacity={.8}>
                                Seriously—navigation is on point, and the cart system works flawlessly.
                            </Text>
                        </CardBody>
                    </Card>
                </Grid>
            ...
            <Accordion>
                <AccordionItem>
                    <h2>
                        <AccordionButton>
                            <Box as="span" fontWeight={800} flex={1} textAlign={"left"}>Made with Chakra ui</Box>
                            <AccordionIcon />
                        </AccordionButton>
                    </h2>
                    <AccordionPanel pb={4}>
                ...
                <AccordionItem>
                    <h2>
                        <AccordionButton>
                            <Box textAlign={"left"} flex={1} fontWeight={800}>Made with React</Box>
                            <AccordionIcon />
                        </AccordionButton>
                    </h2>
                    <AccordionPanel>
